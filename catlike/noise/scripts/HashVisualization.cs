...
public class HashVisualization : MonoBehaviour {
    ...
    struct HashJob : IJobFor {
        ...
        public void Execute(int i) {
            ...
            int u = i - resolution * v - resolution / 2; // hash centered within object
            v -= resolution / 2;
    ...
    void OnEnable() {
        ...
        propertyBlock.SetVector(configId, new Vector4(resolution, 1f / resolution, verticalOffset / resolution)); // store resolution & reciprocal
    }
